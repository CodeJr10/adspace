        ...
        <div className="bg-[#2C2F4A] rounded-lg shadow-lg max-w-md w-full p-6">
          <div className="text-center mb-6">
            <img
              ...
              src="https://images.unsplash.com/photo-1561502332-e2088e3d85ae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwyMDg5MzZ8MHwxfGFsbHwxfHx8fHx8fHwxNjI5ODc0NzE0&ixlib=rb-1.2.1&q=80&w=400"
              alt="Judge Profile"
            />
